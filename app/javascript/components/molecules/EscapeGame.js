      ...
      <CardBody>
        <div>
          <span className="text-muted">
            {renderDifficulty(escapeGame.difficulty_level)}{" "}
            {startCase(escapeGame.difficulty_level)} |{" "}
            <FontAwesomeIcon icon="hourglass-start" />{" "}
            {fuzzyTime(escapeGame.available_time)} |{" "}
            <FontAwesomeIcon icon={chooseGenreIcon(escapeGame.genre)} />{" "}
            {startCase(escapeGame.genre)}
          </span>
        </div>
